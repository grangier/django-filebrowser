...
URL_WWW = getattr(settings, "FILEBROWSER_URL_WWW", settings.MEDIA_URL_ROOT + '/share/img/upload/')

# The FileBrowser Admin-URL.
# Note: If you change this URL, you also have to change the file urls.py.
URL_ADMIN = getattr(settings, "FILEBROWSER_URL_ADMIN", '/filebrowser/')

# The URL to your Admin Index-Site.
URL_HOME = getattr(settings, "FILEBROWSER_URL_HOME", '/')
...
PATH_SERVER = getattr(settings, "FILEBROWSER_PATH_SERVER", os.path.join(settings.MEDIA_ROOT, 'share/img/upload/'))
